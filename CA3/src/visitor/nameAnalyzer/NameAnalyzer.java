...
public class NameAnalyzer extends Visitor<Void> {
    ...
    public Void visit(ForloopStmt forloopStmt) {
        ...
        VariableItem forVarItem = null;
        try {
            var arrItem = (VariableItem) SymbolTable.top.get(VariableItem.STARTKEY + forloopStmt.getArrayName().getName());
            forVarItem = new VariableItem(forloopStmt.getIterator().getName(), arrItem.getType());
        }
