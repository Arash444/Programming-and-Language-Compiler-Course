...
variable returns [Variable v]:
    i = identifier {$v = $i.identifierRet;} | name = identifier LBRACKET exp = expression RBRACKET
...
expression2 returns [BinaryExpression e] locals [BinaryExpression ee]:
    ...
    {if($r.e != null) {$ee = new BinaryExpression($l.e, $r.e.getRight(), $r.e.getBinaryOperator()); $ee.setLine($r.e.getLine());
    $e = new BinaryExpression(null, $ee, BinaryOperator.or);}
    else{$e = new BinaryExpression(null, $l.e, BinaryOperator.or);}}
...
additive2 returns [BinaryExpression e] locals [BinaryOperator opt, BinaryExpression ee]:
    ...
    {if($r.e != null) {$ee = new BinaryExpression($l.e, $r.e.getRight(), $r.e.getBinaryOperator()); $ee.setLine($r.e.getLine());
    $e = new BinaryExpression(null, $ee, $opt);} else{$e = new BinaryExpression(null, $l.e, $opt);}}
    {$e.setLine($op.getLine());}
    |
    {$e = null;}
    ;
...
multicative2 returns [BinaryExpression e] locals [BinaryOperator opt, BinaryExpression ee]:
    (op = MULT {$opt = BinaryOperator.mult;} | op = MOD {$opt = BinaryOperator.mod;}| op = DIV {$opt = BinaryOperator.div;})
    l = unary r = multicative2
